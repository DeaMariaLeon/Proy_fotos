...
DIRECTORY2 = "Dir_de_prueba2/folder2/"
...
def create_dir2(tmp_path_factory):
    ...
    newtemp_dir0 = tmp_path_factory.mktemp( "Dir_de_prueba2/", numbered=False)
...
def test_2(create_dir2):
    ...
    assert get_names(create_dir2) == [(path_with_file, str(create_dir2))]
